...
} else if (match_routes($request_uri, '/suggest-a-drink')) {
  require 'pages/submit-drink.php';
} else if (match_routes($request_uri, '/drinks')) {
  require 'pages/drinks.php';
} else if (match_routes($request_uri, '/drink-details')) {
  require 'pages/drink-details.php';
} else if (match_routes($request_uri, '/login')) {
  require 'pages/login.php';
} else if (match_routes($request_uri, '/tag-details')) {
  require 'pages/tag-details.php';
} else {
